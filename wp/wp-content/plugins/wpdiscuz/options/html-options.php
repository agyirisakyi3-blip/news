...
<div id="wpd-setbox" class="wrap wpd-dash">
    ...
    <div class="wpd-setbox-head">
        ...
        <div class="wpd-head-info">
            <span><a href="https://wpdiscuz.com/docs/wpdiscuz-7/"
                     target="_blank"><?php esc_html_e("Documentation", "wpdiscuz"); ?></a></span>
            <span><a href="https://wpdiscuz.com/support/"
                     target="_blank"><?php esc_html_e("Support", "wpdiscuz"); ?></a></span>
            <span><a href="https://gvectors.com/product-category/wpdiscuz/"
                     target="_blank"><?php esc_html_e("Addons", "wpdiscuz"); ?></a></span>
        </div>
    </div>
    ...
    if ($wizard) {
        ...
        <style>
            ...
            .wpd-wiz-active .wpd-wizard-current {
                width: 7px;
                height: 7px;
                border-radius: 5px;
            ...
            .wpd-wizard-opt .wpd-switch-field input {
                display: none;
            }

            .wpd-wizard-opt .wpd-switch-field label {
                float: left;
            ...
            .wpd-wizard-opt .wpd-switch-field label:hover {
                cursor: pointer;
            }

            .wpd-wizard-opt .wpd-switch-field input:checked + label {
                background-color: #07B290;
            ...
            /* #66DD8D */
            .wpd-wizard-opt .wpd-switch-field label:first-of-type {
                border-radius: 4px 0 0 4px;
            }

            .wpd-wizard-opt .wpd-switch-field label:last-of-type {
            ...
            .wpd-wizard-opt .wpd-wizard-opt-label {
                width: 50%;
                font-size: 15px;
                font-weight: 600;
                text-align: right;
            ...
            .wpd-wizard-opt .wpd-wizard-opt-option {
                width: 50%;
                display: flex;
            ...
            .wpd-wizard-button:hover {
                box-shadow: 1px 1px 20px #07B290;
                background: #0e8e75;
            }

            a.wpd-wizard-button:hover {
                box-shadow: 1px 1px 20px #07B290;
                background: #0e8e75;
                color: #fff;
        ...
        <div class="wpd-wizard">
            ...
            if (in_array($wizard, [1, 2, 3])) {
                ?>
                <form method="post"
                      action="<?php echo admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_wizard=" . ($wizard + 1)); ?>">
                        ...
                        if ($wizard === 1) {
                            ...
                            if ($customizedDir && count(scandir($customizedDir)) > 2) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("Custom wpDiscuz template files are detected!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                                        <span class="dashicons dashicons-welcome-comments"></span>
                                        <strong><?php esc_html_e("Information: ", "wpdiscuz") ?></strong>
                                    ...
                                    <p>
                                        ...
                                        <strong><?php esc_html_e("Fix the problem: ", "wpdiscuz") ?></strong>
                            ...
                            if (intval(get_option(self::OPTION_SLUG_WIZARD_SHOW_ADDONS_MSG)) && !isset($_GET['wpd_addon_fix'])) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("All wpDiscuz Addons are Deactivated!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                                        <span class="dashicons dashicons-welcome-comments"></span>
                                        <strong><?php esc_html_e("Information: ", "wpdiscuz") ?></strong>
                            ...
                            if (class_exists("Jetpack") && Jetpack::is_module_active("comments")) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("Jetpack comments is active, please deactivate!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                                        <span class="dashicons dashicons-welcome-comments"></span>
                                        <strong><?php esc_html_e("Information: ", "wpdiscuz") ?></strong> <?php esc_html_e("Jetpack Comments doesn't allow wpDiscuz comment form to be loaded on your posts and pages. It overwrites wpDiscuz Comment form.", "wpdiscuz"); ?>
                                    </p>
                                    <p>
                                        <span class="dashicons dashicons-yes-alt"></span>
                                        <strong><?php esc_html_e("Fix the problem: ", "wpdiscuz") ?></strong>
                            ...
                            if ($notice) {
                                ...
                                <div class="wpd-wizard-help">
                                    <div style="width: 50%; padding: 20px; box-sizing: border-box;">
                                        <h3>
                                            <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/solved.png")); ?>"/> <?php esc_html_e("I can't resolve the problems!", "wpdiscuz"); ?>
                                        </h3>
                                    ...
                                    <div style="width: 50%; padding: 20px; box-sizing: border-box;">
                                        <h3>
                                            <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/cancel.png")); ?>"/> <?php esc_html_e("I want to downgrade to previous 5.x version!", "wpdiscuz"); ?>
                                        </h3>
                            ...
                            <div class="wpd-wizard-opt wpd-wizard-section">
                                <img class="wpd-opt-img"
                                     src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/box-bubble.png")); ?>"
                                     style="height: 70px; padding: 0px 30px 5px 10px;"/>
                            ...
                            <div class="wpd-wizard-opt" style="padding-bottom: 20px;">
                                ...
                                <div class="wpd-wizard-opt-option">
                                    <div class="wpd-switch-field">
                                        ...
                                        <label for="enableBubble"
                                               style="min-width:60px;"><?php esc_html_e("Enable", "wpdiscuz"); ?></label>
                                        <input type="radio" value="0" name="enableBubble" id="disableBubble"/>
                                        <label for="disableBubble"
                                               style="min-width:60px;"><?php esc_html_e("Disable", "wpdiscuz"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="wpd-wizard-opt" style="padding-bottom: 20px;">
                                ...
                                <div class="wpd-wizard-opt-option">
                                    <div class="wpd-switch-field">
                                        <input type="radio" value="1" name="bubbleLiveUpdate"
                                               id="enableBubbleLiveUpdate"/>
                                        <label for="enableBubbleLiveUpdate"
                                               style="min-width:60px;"><?php esc_html_e("Enable", "wpdiscuz"); ?></label>
                                        <input type="radio" value="0" checked name="bubbleLiveUpdate"
                                               id="disableBubbleLiveUpdate"/>
                                        <label for="disableBubbleLiveUpdate"
                                               style="min-width:60px;"><?php esc_html_e("Disable", "wpdiscuz"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="wpd-wizard-opt" style="border-bottom: none;">
                                ...
                                <div class="wpd-wizard-opt-option">
                                    <div class="wpd-switch-field">
                                        <input type="radio" checked value="content_left" name="bubbleLocation"
                                               id="content_left" class="content_left" style="vertical-align: bottom;"/>
                                        <label for="content_left"
                                               style="min-width:60px;"><?php esc_html_e("Content Left", "wpdiscuz"); ?></label>
                                        <input type="radio" value="left_corner" name="bubbleLocation" id="left_corner"
                                               class="left_corner" style="vertical-align: bottom;"/>
                                        <label for="left_corner"
                                               style="min-width:60px;"><?php esc_html_e("Left Corner", "wpdiscuz"); ?></label>
                                        <input type="radio" value="right_corner" name="bubbleLocation" id="right_corner"
                                               class="right_corner" style="vertical-align: bottom;"/>
                                        <label for="right_corner"
                                               style="min-width:60px;"><?php esc_html_e("Right Corner", "wpdiscuz"); ?></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wpd-wizard-section" style="border-bottom: 2px solid #eee;">
                                ...
                                <img class="wpd-opt-img"
                                     src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/box-feedback.png")); ?>"
                                     style="height: 60px;  padding: 0px 30px 5px 10px; float: left; "/>
                            ...
                            <div class="wpd-wizard-opt" style="border-bottom: none;">
                                ...
                                <div class="wpd-wizard-opt-option">
                                    <div class="wpd-switch-field">
                                        <input checked="checked" type="radio" value="1" name="enable_post_rating"
                                               id="enableArticleRating"/>
                                        <label for="enableArticleRating"
                                               style="min-width:60px;"><?php esc_html_e("Enable", "wpdiscuz"); ?></label>
                                        <input type="radio" value="0" name="enable_post_rating"
                                               id="disableArticleRating"/>
                                        <label for="disableArticleRating"
                                               style="min-width:60px;"><?php esc_html_e("Disable", "wpdiscuz"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="wpd-wizard-section" style="border-bottom: 2px solid #eee;">
                                <img class="wpd-news-icon"
                                     src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/rating.png")); ?>"
                                     style="height: 50px;  padding: 5px 30px 15px 10px; float: left; ">
                    ...
                    <div class="wpd-wizard-foot">
                        <div class="wpd-wizard-buttons">
                            <input class="wpd-wizard-button" type="submit" name=""
                                   value="<?php $wizard === 3 ? (intval(get_option(self::OPTION_SLUG_WIZARD_AFTER_UPDATE)) ? esc_html_e("Finish Update", "wpdiscuz") : esc_html_e("Finish Installation", "wpdiscuz")) : esc_html_e("Next Step &raquo;", "wpdiscuz"); ?>"/>
                        </div>
                    </div>
                    <?php
                ...
                <div class="wpd-wizard-foot">
                    <div class="wpd-wizard-buttons">
                        <a class="wpd-wizard-button"
                           href="<?php echo esc_url_raw(admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS)); ?>"><?php esc_html_e("Start Using wpDiscuz", "wpdiscuz"); ?></a>
                    </div>
                </div>
                <?php
            }
        ...
        <div class="wpd-setbox-body">
            <div class="wpd-section">
                ...
                <div class="wpd-opt-search">
                    <input id="wpd-opt-search-field" type="text" name="" value=""
                           placeholder="<?php esc_attr_e("Find an option...", "wpdiscuz") ?>"/>
                            ...
                            <div class="wpd-box-head">
                                <a href="<?php echo esc_url_raw(admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_tab=" . $tab_key)); ?>"
                                   title="<?php esc_attr_e("Open Settings", "wpdiscuz") ?>">
                                    <img src="<?php echo esc_url_raw(plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/" . $setting["icon"])); ?>"
                ...
                <div id="wpd-settings-tab" class="wpd-box-wrap wpd-settings-tab_<?php echo esc_attr($tab); ?>"
                    ...
                    <div class="wpd-box wpd-setcon">
                        ...
                        <div class="wpd-setcon-body">
                            <form action="<?php echo esc_url_raw(admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_tab=" . $tab)); ?>"
                                  method="post" name="<?php echo esc_attr($tab); ?>"
                                  class="wc-main-settings-form wc-form" enctype="multipart/form-data">
                                <?php
                                ...
                                <div class="wpd-opt-row">
                                    ...
                                    <div>
                                        <a id="wpdiscuz-reset-options" style="text-decoration:none;"
                                           class="button button-secondary"
                                           href="<?php echo esc_url_raw($resetOptionsUrl); ?>"><?php esc_html_e("Reset Tab Options", "wpdiscuz"); ?></a>
                                        <a id="wpdiscuz-reset-all-options" style="text-decoration:none;"
                                           class="button button-secondary"
                                           href="<?php echo esc_url_raw($resetAllTabs); ?>"><?php esc_html_e("Reset All Options", "wpdiscuz"); ?></a>
                                    </div>
