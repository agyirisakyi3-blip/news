        ...
        <tr>
            <td valign="top" style="padding:10px 10px 0px 10px;">
                <table width="100%" border="0" cellspacing="1">
                    <thead>
                    <tr>
                        <th style="font-size:16px; padding-bottom:15px;">
                            <strong><?php esc_html_e("wpDiscuz Add-ons", "wpdiscuz"); ?></strong></th>
                        <th style="font-size:16px; padding-bottom:15px; width:205px; text-align:center; border-bottom:1px solid #008EC2;">
                            <a href="https://gvectors.com/forum/" style="color:#008EC2; overflow:hidden; outline:none;"
                               target="_blank"><?php esc_html_e("Addons Support Forum", "wpdiscuz"); ?></a></th>
                    </tr>
                    </thead>
                    <tr valign="top">
    ...
    <div class="wpdiscuz-addons-wrapper">
        ...
        foreach ($this->addons as $key => $addon) {
                        ...
                        <?php } else { ?>
                            ...
                            <ul>
                                ...
                                <li style="line-height:16px;">
                                    wpDiscuz: <?php esc_html_e("at least", "default"); ?> <?php echo esc_html($addon["requires"]); ?></li>
                            </ul>
            ...
            <script language="javascript">jQuery(document).ready(function ($) {
                    $('#wpdiscuz-addon-<?php echo $key ?>').contenthover({
                        overlay_width: 230,
