...
<div class="wpd-opt-row" data-wpd-opt="theme">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switch-field">
            <input <?php checked($this->thread_styles["theme"] === "wpd-minimal"); ?> value="wpd-minimal"
    ...
    <div class="wpd-opt-input" style="width: calc(100% - 40px);">
        ...
        <div class="wpd-default-style-colors" style="float: left; width: 48%;">
            ...
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentAreaBG"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentAreaBG]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Area Background", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentTextColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentTextColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Text", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentFieldsBG"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentFieldsBG]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Background", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentFieldsBorderColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentFieldsBorderColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Border", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentFieldsTextColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentFieldsTextColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Text", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["defaultCommentFieldsPlaceholderColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[defaultCommentFieldsPlaceholderColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
        ...
        <div class="wpd-dark-style-colors" style="float: right; width: 48%;">
            ...
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentAreaBG"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentAreaBG]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Area Background", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentTextColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentTextColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Text", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentFieldsBG"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentFieldsBG]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Background", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentFieldsBorderColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentFieldsBorderColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Border", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentFieldsTextColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentFieldsTextColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Text", "wpdiscuz"); ?></label>
            </div>
            <div class="wpd-scol-wrap" style="background: #F5F5F5;">
                <input type="text" class="wpdiscuz-color-picker regular-text"
                       value="<?php echo esc_attr($this->thread_styles["darkCommentFieldsPlaceholderColor"]); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[darkCommentFieldsPlaceholderColor]"
                       placeholder="<?php esc_attr_e("default", "wpdiscuz"); ?>"/>
                <label><?php esc_html_e("Comment Fields Placeholder", "wpdiscuz"); ?></label>
            </div>
        </div>
...
<div class="wpd-opt-row" data-wpd-opt="colors">
    <div class="wpd-opt-input" style="width: calc(100% - 40px);">
        ...
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["primaryColor"]); ?>" id="primaryColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[primaryColor]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Primary Color", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["newLoadedCommentBGColor"]); ?>"
                   id="newLoadedCommentBGColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[newLoadedCommentBGColor]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Unread comments background", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["primaryButtonColor"]); ?>" id="primaryButtonColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[primaryButtonColor]"
                   placeholder="<?php esc_attr_e("Text Color", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Primary buttons text", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["primaryButtonBG"]); ?>" id="primaryButtonBG"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[primaryButtonBG]"
                   placeholder="<?php esc_attr_e("Background Color", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Primary buttons background", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["bubbleColors"]); ?>" id="bubbleColors"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[bubbleColors]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Comment Bubble Colors", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->thread_styles["inlineFeedbackColors"]); ?>"
                   id="inlineFeedbackColors"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[inlineFeedbackColors]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
...
<div style="padding: 20px 0 30px 0; font-size: 14px;">
    <a href="<?php echo admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_tab=rating") ?>"><?php esc_html_e("Comment Rating Colors", "wpdiscuz"); ?></a>
    and
    <a href="<?php echo admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_tab=labels") ?>"><?php esc_html_e("Comment Author Label Colors", "wpdiscuz"); ?></a>
</div>
...
<div class="wpd-opt-row" data-wpd-opt="enableFontAwesome">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_styles["enableFontAwesome"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_STYLES); ?>[enableFontAwesome]"
