        ...
        <div class="wpd-stat-graph wpd-box" data-box="wpd_stat_graph">
            ...
            <div class="wpd-box-head">
                ...
                <div class="wpd-box-info"<?php echo $showGraph ? "" : " style='display: none;'" ?>>
                    <span><span class="dashicons dashicons-marker"
                                style="color: #46C08F"></span> <?php esc_html_e("All comments", "wpdiscuz") ?></span>
                    &nbsp;&nbsp;
                    <span><span class="dashicons dashicons-marker"
                                style="color: #0498F9"></span> <?php esc_html_e("Inline feedbacks", "wpdiscuz") ?></span>
                </div>
                <div class="wpd-box-toggle">
                    ...
                    <div class="wpd-graph-tools">
                        <span class="wpd_not_clicked"
                              data-interval="today"><?php esc_html_e("Today", "wpdiscuz") ?></span>
                        <span class="wpd_not_clicked"
                              data-interval="week"><?php esc_html_e("Last Week", "wpdiscuz") ?></span>
                        <span class="wpd_not_clicked"
                              data-interval="month"><?php esc_html_e("Last Month", "wpdiscuz") ?></span>
                        <span class="wpd_not_clicked"
                              data-interval="6months"><?php esc_html_e("Last 6 Months", "wpdiscuz") ?></span>
                        <span class="wpd_not_clicked"
                              data-interval="year"><?php esc_html_e("Last Year", "wpdiscuz") ?></span>
                        <span class="wpd_not_clicked"
                              data-interval="all"><?php esc_html_e("All Time", "wpdiscuz") ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="wpd-box-head">
                ...
                <div class="wpd-box-toggle">
                    <span class="dashicons dashicons-arrow-left"
                          style="visibility: hidden;<?php echo $showUser ? "" : "display: none;"; ?>"></span>
            ...
            <div class="wpd-widget-body">
                ...
                <p style="margin-top:0px;"><?php esc_html_e("We'd really appreciate if you could help translating wpDiscuz to your language.", "wpdiscuz") ?>
                    <a href="https://translate.wordpress.org/projects/wp-plugins/wpdiscuz/"
                       target="_blank"><?php esc_html_e("Just log in to the translation platform with your WordPress.org account, and suggest translations.", "wpdiscuz") ?></a>
                </p>
...
<script>
    jQuery(document).ready(function ($) {
        $('#wpdiscuz-news').wpdiscuzEasyResponsiveTabs({
            type: 'vertical',
            width: 'auto',
            fit: true,
            tabidentify: 'wpdiscuz-news-options'
        });
    });
</script>
